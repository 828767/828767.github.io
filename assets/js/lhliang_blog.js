...
function coverColor() {
  ...
  if (void 0 !== path) {
        ...
        if (4 == httpRequest.readyState && 200 == httpRequest.status) {
          ...
          (value = "#" + value.slice(2)),
            ...
            document.styleSheets[0].addRule(
              ":root",
              "--LHL-main:" + value + "!important"
            ),
            document.styleSheets[0].addRule(
              ":root",
              "--LHL-main-op:" + value + "23!important"
            ),
            document.styleSheets[0].addRule(
              ":root",
              "--LHL-main-op-deep:" + value + "dd!important"
            ),
            document.styleSheets[0].addRule(
              ":root",
              "--LHL-main-none:" + value + "00!important"
            ),
            LHL.initThemeColor(),
    ...
    document.styleSheets[0].addRule(
      ":root",
      "--LHL-main: var(--LHL-theme)!important"
    ),
      document.styleSheets[0].addRule(
        ":root",
        "--LHL-main-op: var(--LHL-theme-op)!important"
      ),
      document.styleSheets[0].addRule(
        ":root",
        "--LHL-main-op-deep:var(--LHL-theme-op-deep)!important"
      ),
      document.styleSheets[0].addRule(
        ":root",
        "--LHL-main-none: var(--LHL-theme-none)!important"
      ),
      LHL.initThemeColor();
}
function colorHex(e) {
  ...
  if (/^(rgb|RGB)/.test(t)) {
    for (
      var o = t.replace(/(?:\(|\)|rgb|RGB)*/g, "").split(","), n = "#", a = 0;
      a < o.length;
      a++
    ) {
      var r = (+o[a]).toString(16);
      "0" === r && (r += r), (n += r);
    }
  ...
  if (3 === i.length) {
    var l = "#";
    for (a = 0; a < i.length; a += 1) l += i[a] + i[a];
    return l;
  }
}
function colorRgb(e) {
...
function LightenDarkenColor(e, t) {
  ...
  return (
    i > 255 ? (i = 255) : i < 0 && (i = 0),
    (o ? "#" : "") +
      ("000000" + (i | (r << 8) | (a << 16)).toString(16)).slice(-6)
  );
}
...
function navTitle() {
  ...
  document.getElementById("page-name-text").innerHTML = e.replace(
    " | 刘洪亮Leo的博客",
    ""
  );
}
...
(checkOpen.toString = function () {
  ...
  (window.onload = function () {
    let e = document.getElementsByClassName("copybtn");
      ...
      ("dark" === document.documentElement.getAttribute("data-theme")
        ...
        ? (activateDarkMode(),
          ...
          void 0 !== GLOBAL_CONFIG.Snackbar &&
            pty.snackbarShow(GLOBAL_CONFIG.Snackbar.day_to_night, !1, 2e3))
        : (activateLightMode(),
          saveToLocal.set("theme", "light", 2),
          void 0 !== GLOBAL_CONFIG.Snackbar &&
            pty.snackbarShow(GLOBAL_CONFIG.Snackbar.night_to_day, !1, 2e3)),
...
function travelling() {
  ...
  if (t) {
    ...
    document.styleSheets[0].addRule(
      ":root",
      "--LHL-snackbar-time:8000ms!important"
    ),
      Snackbar.show({
        text: e,
        duration: 8e3,
        ...
        onActionClick: function (e) {
          $(e).css("opacity", 0), window.open(n, "_blank");
        },
      });
  }
  e = null;
...
function toRandomFlink() {
  let e = Array.from(flinksAll);
  window.open(e[Math.floor(Math.random() * e.length)].link), (e = null);
}
...
function getArrayItems(e, t) {
  let o = [];
  for (let t in e) o.push(e[t]);
  let n = [];
  for (let e = 0; e < t && o.length > 0; e++) {
    let t = Math.floor(Math.random() * o.length);
    (n[e] = o[t]), o.splice(t, 1);
  }
  return n;
}
...
function percent() {
  ...
  r.offsetTop + r.offsetHeight / 2 < a || o > 90
...
function keyDownEvent(e) {
  if (
    (27 == e.keyCode &&
      (LHL.hideLoading(), LHL.hideConsole(), rm.hideRightMenu()),
    ...
    if (
      ...
      return LHL.keyboardToggle(), !1;
    if (65 == e.keyCode) return LHL.showConsole(), !1;
    if (77 == e.keyCode) return LHL.musicToggle(), !1;
    ...
    if (84 == e.keyCode) return pjax.loadUrl("/stars/"), !1;
  }
}
...
function open_all_tags() {
  document.querySelectorAll(".card-allinfo .card-tag-cloud").forEach((e) => {
    e.classList.add("all-tags");
  });
  const e = document.getElementById("more-tags-btn");
...
function listenToPageInputPress() {
  ...
  e &&
    (e.addEventListener("keydown", (e) => {
      13 === e.keyCode && (LHL.toPage(), pjax.loadUrl(t.href));
    }),
...
document.addEventListener(
  ...
  $(document)
    ...
    .bind("keydown", function (e) {
      if ((e.ctrlKey || e.metaKey) && 67 == e.keyCode && "" != selectTextNow)
        return (
          pty.snackbarShow("复制成功，复制和转载请标注本文地址"),
  ...
  (window.onkeydown = function (e) {
    123 === e.keyCode &&
      pty.snackbarShow("开发者模式已打开，请遵循GPL协议", !1, 3e3);
  }),
